        ...
        <aside id="sidebar" class="w-64 bg-gray-800 text-white flex-shrink-0 flex flex-col transition-transform duration-300 shadow-xl fixed inset-y-0 left-0 z-50 transform -translate-x-full md:relative md:translate-x-0">
            ...
            <nav class="flex-1 overflow-y-auto py-4">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ route('users.index') }}" class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-700 hover:text-white transition-colors {{ request()->routeIs('users.*') ? 'bg-gray-700 text-white border-l-4 border-blue-500' : '' }}">
